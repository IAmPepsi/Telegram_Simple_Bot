...
def get_response(message):
    ...
    response_list = [
        ...
        process_message(message, ['i', 'miss', 'you'], 'i miss you more!'),
        process_message(message, ['good', 'morning', 'goodmorning'], 'good morning'),
        process_message(message, ['good', 'night', 'goodnight'], 'good night and sweet dreams'),
        process_message(message, ['where', 'are', 'you'], 'at home'),
        process_message(message, ['call', '?'], 'later'),
        process_message(message, ['What', 'are', 'you', 'doing'], 'Nothing and You!'),
